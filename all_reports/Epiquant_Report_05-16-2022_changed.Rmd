...
TP2_lineage <- TP2_lineage %>% 
  ...
  select(TP2_Cluster_Size, Pango_lineage, Size, `Actual_growth by rate`, `Novel_growth by rate`, T0.original)
# ADDED ------------------------
# TP2_lineage$TP2_Cluster <- TP2_lineage$TP2_Cluster_Size %>% 
#   lapply(., function(x_i) {strsplit(x_i, split = "-")[[1]][1]}) %>% unlist()
# TP2_lineage$TP2_Cluster <- paste(TP2_lineage$TP2_Cluster, TP2_lineage$Pango_lineage, sep = "-")
