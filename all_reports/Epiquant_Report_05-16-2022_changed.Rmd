...
```{r }
source("captions.R")    ## Create figure caption variables 
```
...
## TP1+TP2 plot
P3 <- ggplot(Bubble_Plot_data1, aes(fill= Timepoint, lable1=T0.original, size = Cluster_Size, 
                                    lable12= `Cluster growth by size`, lable13= `Novel_growth by rate`)) +
  theme_bw() + 
  geom_point(aes(x=Geo_ECC, y= Temp_ECC, lable4=Delta_Geo_ECC, lable5=Delta_Temp_ECC), 
...
P3 <- ggplot(P4data, aes(fill= Timepoint, lable1=T0.original, size = Cluster_Size, 
                         lable12= `Cluster growth by size`, lable13= `Novel_growth by rate`)) + 
  theme_bw() +
  geom_point(aes(x=Geo_ECC, y= Temp_ECC, lable4=Delta_Geo_ECC, lable5=Delta_Temp_ECC), 
...
P2 <- ggplot(P3data, aes(fill= Timepoint, lable1=T0.original, size = Cluster_Size, 
                         lable12= `Cluster growth by size`, lable13= `Novel_growth by rate`)) +
  theme_bw() +
  geom_point(aes(x=Geo_ECC, y= Temp_ECC, lable4=Delta_Geo_ECC, lable5=Delta_Temp_ECC), 
             alpha=0.8, shape=21, color= "black") + 
...
P1 <- ggplot(P2data, aes(fill= TP1_Size, lable1=T0.original, size = Cluster_Size, 
                         lable12= `Cluster growth by size`, lable13=`Novel_growth by rate`)) + 
  theme_bw() +
  geom_point(aes(x=Geo_ECC, y= Temp_ECC, lable4=Delta_Geo_ECC, lable5=Delta_Temp_ECC), 
             alpha=0.8, shape=21, color= "black") +
