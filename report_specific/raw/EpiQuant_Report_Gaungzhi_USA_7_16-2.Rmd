...
Lineages <-  read.csv("GISAID Lineages (77000 isolates).csv",encoding="UTF-8", stringsAsFactors=FALSE)%>%select("Strain", "T0.original") # Add Lineage information
EU_long <-merge(x = EU_long, y = Lineages, by = "Strain", all.x=TRUE)
# creat an new date varible in T0000_long , need to load the package: ‘lubridate'
